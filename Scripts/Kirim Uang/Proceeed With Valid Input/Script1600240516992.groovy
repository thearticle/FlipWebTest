...
WebUI.click(findTestObject('Object Repository/Page_Konfirmasi Transaksi/button_SAYA SUDAH TRANSFER'))

WebUI.click(findTestObject('Object Repository/Page_Transaksi sedang diproses/span_Lihat'))

WebUI.verifyElementText(findTestObject('Page_Transaksi sedang diproses/Konfirmasi 3 Rekening Penerima'), '90011236271')

WebUI.verifyElementText(findTestObject('Page_Transaksi sedang diproses/Konfirmasi 3 Nama Penerima'), 'MUHAMMAD FAUZAN AFIANTO')

WebUI.verifyElementText(findTestObject('Page_Transaksi sedang diproses/Konfirmasi 3 Nominal'), 'Rp10.000')
